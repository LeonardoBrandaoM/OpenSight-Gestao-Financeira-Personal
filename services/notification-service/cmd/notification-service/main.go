// Comando notification-service — feed consolidado de alertas ao usuário.
package main
...
import (
	...
	"opensight/services/notification-service/internal/api"
	"opensight/services/notification-service/internal/repository"
)

func main() {
	log.SetFlags(log.LstdFlags | log.LUTC)
	cfg := httpkit.LoadConfig("8093")
	...
	go func() {
		log.Printf("notification-service ouvindo em :%s", cfg.Port)
