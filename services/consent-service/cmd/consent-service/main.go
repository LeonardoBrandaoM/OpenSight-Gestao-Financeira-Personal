// Comando consent-service — consentimentos Open Finance (LGPD).
package main
...
import (
	...
	"opensight/services/consent-service/internal/api"
	"opensight/services/consent-service/internal/repository"
)

func main() {
	log.SetFlags(log.LstdFlags | log.LUTC)
	cfg := httpkit.LoadConfig("8087")
	...
	go func() {
		log.Printf("consent-service ouvindo em :%s", cfg.Port)
