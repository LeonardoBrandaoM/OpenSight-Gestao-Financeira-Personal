// Comando cards-service — visão somente leitura de cartões de crédito.
package main
...
import (
	...
	"opensight/services/cards-service/internal/api"
	"opensight/services/cards-service/internal/repository"
)

func main() {
	log.SetFlags(log.LstdFlags | log.LUTC)
	cfg := httpkit.LoadConfig("8089")
	...
	var repo repository.CardRepository
	if cfg.DatabaseURL != "" {
	...
	go func() {
		log.Printf("cards-service ouvindo em :%s", cfg.Port)
