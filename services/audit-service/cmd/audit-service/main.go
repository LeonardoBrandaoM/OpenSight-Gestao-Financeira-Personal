// Comando audit-service — trilha de auditoria append-only (imutável).
package main
...
import (
	...
	"opensight/services/audit-service/internal/api"
	"opensight/services/audit-service/internal/repository"
)

func main() {
	log.SetFlags(log.LstdFlags | log.LUTC)
	cfg := httpkit.LoadConfig("8094")
	...
	go func() {
		log.Printf("audit-service ouvindo em :%s", cfg.Port)
