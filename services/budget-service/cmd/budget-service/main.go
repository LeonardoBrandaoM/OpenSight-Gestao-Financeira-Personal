// Comando budget-service — metas orçamentárias, sugestões e comprometimento.
package main
...
import (
	...
	"opensight/services/budget-service/internal/api"
...
func main() {
	...
	var repo repository.BudgetRepository
	if cfg.DatabaseURL != "" {
	...
	go func() {
		log.Printf("budget-service ouvindo em :%s", cfg.Port)
