// Comando cohort-service — benchmarking de pares (RF-012). Agregados/anonimizados.
package main
...
import (
	...
	"opensight/services/cohort-service/internal/api"
	"opensight/services/cohort-service/internal/repository"
)

func main() {
	log.SetFlags(log.LstdFlags | log.LUTC)
	cfg := httpkit.LoadConfig("8088")
	...
	var repo repository.CohortRepository
	if cfg.DatabaseURL != "" {
	...
	go func() {
		log.Printf("cohort-service ouvindo em :%s", cfg.Port)
